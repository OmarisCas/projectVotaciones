<body>
  ...
  <div class="container mt-4">
    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
          ...
          <ul class="nav navbar-nav">
              ...
              <li style="font-size: 16px;" class="active"><a href="consejoPrograma.php">Consejos de Programa<!--contenido--></a></li>
    ...
    <div class="panel panel-warning" style="font-size: 18px; height: 420px;">
    ...
    <ul>
      ...
      <li class="col-xs-2 list-group-item">
        <input class="chk" id="cb103" name="chk[]" value="2013213033" type="checkbox" />
        <label for="cb103">
          <img style="width: 100%;height: 145px" src="../../assets/img/candidatos/img9.jpg"/>

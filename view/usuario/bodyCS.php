<body>
  ...
  <div class="container mt-4">
    ...
    <nav class="navbar navbar-default">
        <div class="container-fluid">
          ...
          <ul class="nav navbar-nav">
              <li style="font-size: 16px;" class="active" style=""><a href="">Consejo Superior</a></li>
    ...
    <div class="panel panel-danger" style="font-size: 18px;height: 420px;">
  ...
  <div class="modal fade" id="voto_realizado" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary"  data-dismiss="modal" onclick="window.location.href='consejoAcademico.php'"> ACEPTAR </button>
        </div>
      </div>
    </div>
  </div>
